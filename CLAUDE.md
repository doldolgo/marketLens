...
실행 순서 = 번호 순. 재구축 중인 스펙(IN_PROGRESS·TODO)은 **007** 하나 남았다 — 001·003·004·005·006·009·010·011·012(DONE)가 토대(행·틱·계약·3거래소 스트림·김프 표·단일 종목 분석·이력 조회·입출금 상태·틱 저장 3계층·원문 아카이브·실패 이력)이고 나머지가 그 위에 얹힌다.
