...
## 이 레포
**재구축 중**: CLAUDE.md §4 에서 IN_PROGRESS·TODO 인 스펙(001·003·004·005·006·007·009·010·011·012)은 문서가 목표 구조(WebSocket 수집·틱 인계·원문 아카이브)를 말하고, 아래 표는 아직 **재구축 전 런타임**을 말한다. 각 실행 세션이 끝날 때 그 행을 갱신한다.

| 기능 | server | web | 비고 |
|---|---|---|---|
| collect | 1초 수집 루프·커넥터 3종·`/health` 동작, 바이낸스 행에 깊이 스트림 캐시 적재 | - | `/refresh` 노출은 003 몫 |
