...
| web-shell | - | 셸·KPI·mock 탭 4종 동작 | spreads·history 탭은 각 기능 폴더가 담당 |
...
| deploy | Dockerfile·compose 3컨테이너·CI/deploy 워크플로 | nginx 서빙(:${WEB_PORT}) | EC2 가동 중(:8080 공존), main 머지 = 자동 배포 |
